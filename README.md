...
A ``.Net 9.0`` WebApi project. MediatR, Swagger, Mapperly, Serilog and more implemented.
...
## Standalone
1. You need a running MySQL instance, with appropriate migrations initialized.
...
## Running tests
**Important**: You need to have docker up and running. The integration tests will launch a MySQL container and use it to test the API.
...
# Domain
The current domain contains Category, Formation, Session, UserSession, and the Anam AI trainer.
